...
```{r 1.1 partition, include=FALSE}
optdigits <- read.csv("D:/Program/Git/Repo/732A99-MachineLearning/lab01/Assignment1/optdigits.csv", header = FALSE)
...
For this reason, K = 4 may possibly be the optimal value.
...
- K == 10 is the optimal value due to the plot.  
